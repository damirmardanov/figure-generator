...
namespace Sobel
{
    class Program
    {
        ...
        */
        ...
        {
            const string inputPath = @"C:\Directory\filteredoutput.png";
            const string outputPath = @"C:\Directory\readyedges.png";
            ...
            Console.Write(image.PixelFormat);
            ...
            for (int y = 0; y < height; y++)
            {
                for (int x = 0; x < width; x++)
                {
                    ...
                    HSVtoRGB(hue, 0, val, out r, out g, out b); // Using a saturation of 0 will make the image grayscale i.e. regular sobel.
