...
namespace GaussianBlur
{
    class Program
    {
        ...
        */
        ...
        {
            const string inputPath = @"C:\Directory\output.png";
            const string outputPath = @"C:\Directory\filteredoutput.png";
            ...
            double[] kernel = Create1DGaussianKernel(0.2); // Kernel to be convolved
